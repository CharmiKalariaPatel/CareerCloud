    ...
    public class ApplicantProfileLogic: BaseLogic<ApplicantProfilePoco>
    {
        ...
        protected override void Verify(ApplicantProfilePoco[] pocos)
        {
            ...
            foreach (var poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(111, $"CurrentRate for AplicantProfile {poco.Id}  must positive value."));
                }
                if (poco.CurrentRate < 0)
                {
                    exceptions.Add(new ValidationException(112, $"currentSalary for AplicantProfile {poco.Id}  must positive ."));
